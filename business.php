...
<head>
    ...
    <!-- default theme -->
    <link href="stylesheets/css/base/default.css" rel="stylesheet">
    <link href="stylesheets/css/base/color.css" rel="stylesheet">
    <link href="stylesheets/css/base/font.css" rel="stylesheet">
...
<body id="common-page">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav pull-right quick-menu">
                        ...
                        <li>
                            <a class="square-social" href="#">Login</a>
                        </li>
                        <li>
                            <a class="square-social" href="#">Join</a>
                        </li>
                    </ul>
    
                    <ul class="nav navbar-nav pull-right">
                        <li>
                            <a class="hvr-bounce-to-top" href="#">Home</a>
                        </li>
                        <li>
                            <a class="hvr-bounce-to-top" href="#">Business</a>
                        </li>
                        <li>
                            <a class="hvr-bounce-to-top" href="#">Categories</a>
                        </li>
                        <li>
                            <a class="hvr-bounce-to-top" href="#">Store Locator</a>
                        </li>
                        <li>
                            <a class="hvr-bounce-to-top" href="#">Blog</a>
                        </li>
                        <li>
                            <a class="hvr-bounce-to-top" href="#">About</a>
                        </li>
                        <li>
                            <a class="hvr-bounce-to-top" href="#">Contact</a>
                        </li>
                    </ul>
    ...
    <section class="fluid-wrapper">
    	<div id="cmap" class="contactmap" style="height: 70vh;"></div>
    </section>

    <section class="float-top">
    	<div class="container">
    		<div class="section-search">
	            <form action="">
	                <input type="text" placeholder="What are you looking for?">  
	                <input type="text" placeholder="Where? (suburb, postcode, or city)">  
	                <button class="search-submit hvr-grow" ><i class="fa fa-search" aria-hidden="true"></i> Find</button>
	            </form>
	        </div>
    	</div>
    </section>
    			...
    			<div class="col-md-9">
    				...
    				<div class="text-center margin-bottom-40">
					    <ul class="pagination">
					        ...
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=2">2</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=3">3</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=4">4</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=5">5</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=6">6</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=7">7</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=8">8</a></li>
					        <li class="disabled"><span>...</span></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=105">105</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=106">106</a></li>
					        <li><a href="https://hair.com.au/search?location=South+Australia&amp;q=&amp;page=2" rel="next">»</a></li>
					    </ul>
					    <!-- web-pagination -->
					    <div>Page <span>1 of 106 </span></div>
					</div>
    ...
    $(document).ready(function(){
        ...
        var myLatLng = {lat: -33.44743, lng: 151.44527};
